...
class PSTHObject(TimeHistogramObject):
    ...
    event_label : str, optional
        Label of the event in the PSTH.
        Default: "".
    units : pq.Quantity, optional
        Unit of `bins`.
        Default: pq.dimensionless.
    ...
    def from_time_histogram(cls, histogram, event_time, event_label=None):
        """
        Creates a PSTH object from a previously calculated time histogram.
        ...
        Returns
        -------
        obj : buffalo.objects.PSTHObject
            PSTH around event defined by `event_time`.
