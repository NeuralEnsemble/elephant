...
since :cite:`granger-granger1969investigating`. In its simplest form, the
...
not be accounted for :cite:`granger-seth2007granger`.

Implementation
++++++++++++++
The mathematical implementation of Granger causality methods in this module
closely follows :cite:`granger-ding2006granger`.
