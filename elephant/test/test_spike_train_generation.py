...
class HomogeneousPoissonProcessTestCase(unittest.TestCase):
    ...
    def test_statistics(self):
        ...
        D, p = kstest(intervals, "expon", args=(0, expected_mean_isi),  # args are (loc, scale)
...
class HomogeneousGammaProcessTestCase(unittest.TestCase):
    ...
    def test_statistics(self):
        ...
        # Kolmogorov-Smirnov test
        D, p = kstest(intervals, "gamma", args=(a, 0, (1/b).rescale(t_stop.units)),  # args are (a, loc, scale)
                      alternative='two-sided')
        self.assertGreater(p, 0.001)
