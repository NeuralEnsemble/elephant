...
class SpadeTestCase(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        output_msip_min_occ = spade.spade(self.msip, self.bin_size, self.winlen,
        ...
        output_msip_max_occ = spade.spade(self.msip, self.bin_size, self.winlen,
