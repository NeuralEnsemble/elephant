...
class MultitaperPSDTestCase(unittest.TestCase):
    ...
    def test_multitaper_psd_against_nitime(self):
        ...
        multitaper against nitime (0.8.1) using a predifined time series
        ...
        Nitime result generated using:
        nitime.algorithms.multi_taper_psd(time_series, Fs=fs, NW=4,
                                          jackknife=False, low_bias=False)
        """

        time_series = np.load('time_series.npy')
        psd_nitime = np.load('psd_nitime.npy')
