...
/**
 * The size of a shared memory static array. Shared memory is "shared"
...
__global__ void jsf_uniform_orderstat_3d_kernel(asset_float *P_out, float *log_du_device) {
    ...
    __shared__ float shared_mem[SHARED_MEM_SIZE];
    asset_float *P_total = (asset_float*) shared_mem;  // L_BLOCK floats or doubles
