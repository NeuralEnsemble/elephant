...
`_filter_process(time_step, h, spk)` that assigns at each time `t` the difference
...
def multiple_filter_test(window_sizes, spiketrain, t_final, alpha,
    ...
    sliding the windows of step `time_step`; at each step the difference between spike
...
def _brownian_motion(t_in, t_fin, x_in, time_step):
    ...
    Returns
    -------
    Brownian motion on [t_in, t_fin], with resolution time_step and initial state x_in
    """
